...
class Win95Resizable extends StatelessComponent {
  final ResizableProps props;

  const Win95Resizable(this.props, {super.key});

  @override
  Component build(BuildContext context) {
    final bool horizontal = props.direction == ResizeDirection.horizontal;
    return dom.div(
      classes: 'win95-resizable ${horizontal ? 'horizontal' : 'vertical'}',
      attributes: {
        'data-resizable': 'true',
...
Component _panel(ResizablePanelData panel, bool horizontal, int index) {
  final String basis = panel.defaultSize != null
      ...
      : 'auto';
  return dom.div(
    classes: 'win95-resizable-panel ${panel.collapsible ? 'collapsible' : ''}',
    attributes: {
...
Component _handle(
  ...
  return dom.div(
    classes: 'win95-resizable-handle',
    attributes: {
