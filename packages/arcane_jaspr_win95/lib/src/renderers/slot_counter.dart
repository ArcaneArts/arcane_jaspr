...
/// Win95 Slot Counter renderer (stateful with animation, neutral placeholder skeleton).
class Win95SlotCounter extends StatefulComponent {
  final SlotCounterProps props;

  const Win95SlotCounter(this.props, {super.key});

  @override
  State<Win95SlotCounter> createState() => _Win95SlotCounterState();
}

class _Win95SlotCounterState extends State<Win95SlotCounter> {
...
/// Win95 Slot Counter Row renderer (neutral placeholder skeleton).
class Win95SlotCounterRow extends StatelessComponent {
  final SlotCounterRowProps props;

  const Win95SlotCounterRow(this.props, {super.key});

  @override
  Component build(BuildContext context) {
    return dom.div(
      classes: 'win95-slot-counter-row',
      styles: dom.Styles(
        raw: {
          'display': 'flex',
      ...
      [for (final counter in props.counters) Win95SlotCounter(counter)],
    );
  }
}

/// Win95 Slot Counter Card renderer (neutral placeholder skeleton).
class Win95SlotCounterCard extends StatelessComponent {
  final SlotCounterCardProps props;

  const Win95SlotCounterCard(this.props, {super.key});
  ...
  Component build(BuildContext context) {
    return dom.div(
      ...
      [Win95SlotCounter(props.counter)],
    );
  }
}
