...
/// Win95 Fullscreen Takeover renderer (neutral placeholder skeleton).
///
/// A full-screen takeover for major promotions.
class Win95FullscreenTakeover extends StatefulComponent {
  final FullscreenTakeoverProps props;

  const Win95FullscreenTakeover(this.props, {super.key});

  @override
  State<Win95FullscreenTakeover> createState() =>
      _Win95FullscreenTakeoverState();
}

class _Win95FullscreenTakeoverState extends State<Win95FullscreenTakeover> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'win95-fullscreen-takeover',
      styles: dom.Styles(
        raw: {
          'position': 'fixed',
          'inset': '0',
      ...
      [
        ...
        // Decorative elements (neutralized: no win95 glow)
        const dom.div(
          styles: dom.Styles(
            raw: {
              'position': 'absolute',
