...
/// Win95 Expanding FAB Promo renderer (neutral placeholder skeleton).
///
/// A floating action button that expands into a full promo panel when tapped.
class Win95ExpandingFabPromo extends StatefulComponent {
  final ExpandingFabPromoProps props;

  const Win95ExpandingFabPromo(this.props, {super.key});

  @override
  State<Win95ExpandingFabPromo> createState() => _Win95ExpandingFabPromoState();
}

class _Win95ExpandingFabPromoState extends State<Win95ExpandingFabPromo> {
  ...
  Component build(BuildContext context) {
    ...
    if (!_isExpanded) {
      // Collapsed FAB state
      return dom.button(
        classes: 'win95-expanding-fab-promo collapsed',
        styles: dom.Styles(
          raw: {
            'position': 'fixed',
            'bottom': '2rem',
    ...
    return dom.div(
      classes: 'win95-expanding-fab-promo expanded',
      styles: dom.Styles(
        raw: {
          'position': 'fixed',
          'bottom': '2rem',
