...
/// Win95 Progress Claim Banner renderer (neutral placeholder skeleton).
///
/// A banner showing how many people have claimed an offer.
class Win95ProgressClaimBanner extends StatefulComponent {
  final ProgressClaimBannerProps props;

  const Win95ProgressClaimBanner(this.props, {super.key});

  @override
  State<Win95ProgressClaimBanner> createState() =>
      _Win95ProgressClaimBannerState();
}

class _Win95ProgressClaimBannerState extends State<Win95ProgressClaimBanner> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'win95-progress-claim-banner',
      styles: dom.Styles(
        raw: {
          'position': 'fixed',
          'bottom': '1.5rem',
