...
/// Win95 Bottom Floating Banner renderer (neutral placeholder skeleton).
///
/// Bottom floating banner that slides up with optional countdown timer.
class Win95BottomFloatingBanner extends StatefulComponent {
  final BottomFloatingBannerProps props;

  const Win95BottomFloatingBanner(this.props, {super.key});

  @override
  State<Win95BottomFloatingBanner> createState() =>
      _Win95BottomFloatingBannerState();
}

class _Win95BottomFloatingBannerState extends State<Win95BottomFloatingBanner> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'win95-bottom-floating-banner',
      styles: dom.Styles(
        raw: {
          'position': 'fixed',
          'bottom': '1.5rem',
