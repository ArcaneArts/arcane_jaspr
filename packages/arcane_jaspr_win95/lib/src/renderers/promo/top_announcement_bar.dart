...
/// Win95 Top Announcement Bar renderer (neutral placeholder skeleton).
///
/// A thin sticky announcement bar at the top of the page.
class Win95TopAnnouncementBar extends StatefulComponent {
  final TopAnnouncementBarProps props;

  const Win95TopAnnouncementBar(this.props, {super.key});

  @override
  State<Win95TopAnnouncementBar> createState() =>
      _Win95TopAnnouncementBarState();
}

class _Win95TopAnnouncementBarState extends State<Win95TopAnnouncementBar> {
