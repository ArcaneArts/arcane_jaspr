...
/// Win95 Promo Modal renderer (neutral placeholder skeleton).
///
/// Full-screen modal popup for high-priority promotions.
class Win95PromoModal extends StatefulComponent {
  final PromoModalProps props;

  const Win95PromoModal(this.props, {super.key});

  @override
  State<Win95PromoModal> createState() => _Win95PromoModalState();
}

class _Win95PromoModalState extends State<Win95PromoModal> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'win95-promo-modal-overlay',
