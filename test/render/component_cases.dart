...
Widget get _icon => ArcaneIcon.house();
List<ArcaneMenuItem> get _menuItems =>
    const <ArcaneMenuItem>[MenuItemAction(label: 'Item'), MenuItemSeparator()];
...
List<(String, Widget)> componentCases() => <(String, Widget)>[
      ...
      ('FancyIcon', FancyIcon(icon: Icons.calendar)),
      ...
      (
        'ArcaneTabs',
        const ArcaneTabs(tabs: <ArcaneTabItem>[
          ArcaneTabItem(label: 'One', content: Text('one')),
        ])
      ),
      (
        'ArcaneTabBar',
      ...
      // ---- Input -----------------------------------------------------------
      ('Button', const Button(label: 'Press')),
      ...
      ('OutlineButtonMenu', OutlineButtonMenu(child: _child, items: _menuItems)),
      ('Search', const Search()),
      (
        'Selector',
        Selector<String>(
      ...
      (
        ...
        const ArcaneSelect(
          options: <ArcaneSelectOption>[
            ArcaneSelectOption(value: 'a', label: 'A'),
          ],
        )
      ),
      ...
      (
        'ArcaneRangeSlider',
        const ArcaneRangeSlider(minValue: 10, maxValue: 80)
      ),
      ...
      (
        'ArcaneAvatarGroup',
        const ArcaneAvatarGroup(avatars: <ArcaneAvatar>[ArcaneAvatar(initials: 'A')])
      ),
      ...
      (
        'ArcaneHoverCard',
        ArcaneHoverCard(trigger: _child, textContent: 'tip')
      ),
      ...
      (
        'ArcaneContextMenu',
        ArcaneContextMenu(trigger: _child, items: _menuItems)
      ),
      (
        'ArcaneMenubar',
        const ArcaneMenubar(
      ...
      (
        'ConfirmText',
        const ConfirmText(title: 'Delete', confirmPhrase: 'DELETE')
      ),
      (
        'ArcaneCommand',
        const ArcaneCommand(
      ...
      (
        ...
        const ArcaneFaqAccordion(
          faqs: <({String answer, String question})>[
            (question: 'Q', answer: 'A'),
          ],
        )
      ),
      ...
      (
        ...
        const ArcaneTopAnnouncementBar(message: 'News')
      ),
      (
        'ArcaneBottomFloatingBanner',
        const ArcaneBottomFloatingBanner(title: 'Hi', message: 'There')
      ),
      (
        'ArcaneCornerPromoToast',
        const ArcaneCornerPromoToast(title: 'Hi', message: 'There')
      ),
      (
        'ArcaneExpandingFabPromo',
        const ArcaneExpandingFabPromo(title: 'Hi', message: 'There')
      ),
      (
        'ArcaneFullscreenTakeover',
        const ArcaneFullscreenTakeover(headline: 'Hi', subheadline: 'There')
      ),
      ('ArcaneInlineHeroBanner', const ArcaneInlineHeroBanner(message: 'Hi')),
      (
        'ArcaneMarqueeTickerBar',
        const ArcaneMarqueeTickerBar(messages: <String>['One', 'Two'])
      ),
      (
        'ArcaneMinimizablePromo',
        const ArcaneMinimizablePromo(title: 'Hi', message: 'There')
      ),
      (
      ...
      (
        'ArcanePromoModal',
        const ArcanePromoModal(title: 'Hi', subtitle: 'There')
      ),
      (
        'ArcaneSlidingSidebarBanner',
        const ArcaneSlidingSidebarBanner(title: 'Hi', message: 'There')
      ),
      ...
      (
        'OnHover',
        OnHover(action: (bool _) {}, child: _child)
      ),
      (
        'OnGesture',
