...
///
/// Branded button for Discord OAuth authentication.
///
/// ```dart
/// DiscordSignInButton(
...
/// )
/// ```
class DiscordSignInButton extends StatelessComponent {
  /// Click handler
  ...
  const DiscordSignInButton({
    this.onPressed,
    this.label = 'Continue with Discord',
