...
enum Background {
  ...
  String get css => switch (this) {
    ...
    Background.navbar =>
      'var(--arcane-navbar, color-mix(in srgb, var(--background) 80%, transparent))',
    ...
    Background.accentContainer =>
      'var(--arcane-accent-container, color-mix(in srgb, var(--primary) 10%, transparent))',
    Background.success => 'var(--success)',
    Background.successContainer =>
      'var(--arcane-success-container, color-mix(in srgb, var(--success) 10%, transparent))',
