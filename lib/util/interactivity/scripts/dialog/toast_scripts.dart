...
class ToastScripts {
  ...
  function createToast(variant, message, options) {
    ...
    var icons = {
      ...
      loading: '<span class="arcane-loader" style="--arcane-loader-size: 20px;" role="status" aria-label="Loading"></span>'
    };
  ...
  function createToasterContainer(position) {
    ...
    var themeRoot = document.getElementById('arcane-root');
    (themeRoot || document.body).appendChild(toaster);
    return toaster;
  }
''';
}
